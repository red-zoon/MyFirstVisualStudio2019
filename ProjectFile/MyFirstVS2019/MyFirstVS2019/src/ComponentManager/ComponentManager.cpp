...
void ComponentManager::addTestOutput(const std::shared_ptr<GameObject> gameObject, const std::shared_ptr<GameObjectManager> gameObjectManager, const std::shared_ptr<ComponentManager> componentManager) {
...
void ComponentManager::addCloneObject(const std::shared_ptr<GameObject> gameObject, int& num, const std::shared_ptr<GameObjectManager> gameObjectManager, const std::shared_ptr<ComponentManager> componentManager) {
	_cloneNum = num;
...
void ComponentManager::addDestroyObject(const std::shared_ptr<GameObject> gameObject, const std::string& target, const std::shared_ptr<GameObjectManager> gameObjectManager, const std::shared_ptr<ComponentManager> componentManager) {
	_target = target;
